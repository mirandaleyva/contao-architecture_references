...
$GLOBALS["TL_DCA"]["tl_architecture_references"] = [
  ...
  "fields" => [
    ...
    "short_description" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["short_description"],
      "inputType" => "textarea",
    ...
    "long_description" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["long_description"],
      "inputType" => "textarea",
    ...
    "completion" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["completion"],
      "inputType" => "text",
      "eval" => ["maxlength" => 255, "tl_class" => "w50"],
      "sql" => "varchar(255) NOT NULL default ''",
    ],
    ...
    "photographer" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["photographer"],
      "inputType" => "text",
      "eval" => ["maxlength" => 255, "tl_class" => "w50"],
      "sql" => "varchar(255) NOT NULL default ''",
    ],
    ...
    "visualizer" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["visualizer"],
      "inputType" => "text",
      "eval" => ["maxlength" => 255, "tl_class" => "w50"],
      "sql" => "varchar(255) NOT NULL default ''",
    ],
    ...
    "photographer_link" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["photographer_link"],
      "inputType" => "text",
    ...
    "visualizer_link" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["visualizer_link"],
      "inputType" => "text",
      "eval" => ["rgxp" => "url", "maxlength" => 255, "tl_class" => "w50"],
      "sql" => "varchar(255) NOT NULL default ''",
    ],
    ...
    "preview_image" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["preview_image"],
      "inputType" => "fileTree",
      "eval" => [
        "files" => true,
        "fieldType" => "radio",
    ...
    "published" => [
      "label" =>
        &$GLOBALS["TL_LANG"]["tl_architecture_references"]["published"],
      "inputType" => "checkbox",
